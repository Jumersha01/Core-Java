...
Displaying Batch_51_Assignment.txt.
 */
...
public class ClassNotFoundExpDemo {
	...
	public static void main(String[] args) {
		...
		String classna = sc.nextLine();

		new ClassNotFoundExpDemo(classna);
	...
	public ClassNotFoundExpDemo(String className) {
		...
		try {
			...
			IO.println("Class loaded Succesfully: " + className);
		} catch (ClassNotFoundException e) {
			IO.println("Error:" + className + " Not found");
			e.printStackTrace();
		}
	}
